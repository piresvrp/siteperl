...
<div id="geral">
	...
	<div id="menu">
		...
		<ul>
			...
			<li><a href="instalacao.pl"class="active"title="Instalçao do perl" >Instalação</a></li>
	...
	<div id="conteudo">
		...
		<div id="instalar">	
						...
						<h4 style="color:#09c">Instalando o Perl</h4><br><br />
							...
							<p>Para verificar se Sua distribuição tem o perl instalado digite o seguinte comando:<br>
								<h5> perl -v</h5></p>
							

							<p>	Praticamente quase todas distribuições linux tem o perl instalado mas não caso esteja
  								digite o seguinte comando : <br />
                			<h5> sudo apt-get install perl</h5></p>
  								após esse Comando insira sua senha de root. para completar a instalação<br />
                        		<br />
							...
							<h5> sudo apt-get install build-essential</h5><br/>
								Após isso coloque esse comando iniciar o gerenciador<br/><br/>
                				<h5> CPAN</h5><br/>
 					 			Algumas perguntas irão aparecer apenas apenas digite "no" para facilitar"
								
								Digite esse comando apos a pergunta :What approach do you want? e agurade ....</br></br>
				
								<h5>local :: lib</h5>
								
  								</br>Após terminar o processo Digitte os seguintes Comandos para concluir a seguinte instalação
								Respeite os espaços maiuculas e minusculas<br/> 
								<br/> <h5> capan[x]> make install<br/> <br/> 
								capan[x]> Install  Bundle :: CPAN</h5><br/> <br/> 
                    
								<p>Agora tudo está definido e você pode instalar qualquer módulo perl que você querer.
					...
					<h4>Instale Servidor Apache </h4><br />
								<p>para trablhar com perl web voçê deverá baixar o apache digite o seguinte comando:
						...
						<br /><h4>Instale o SGBD Mysql </h4><br />
								...
								<h5>sudo apt-get install mysql-server  libdbd-mysql-perl </h5><br />
									logo em seguinda coloque sua senha de root durante o processo serão
									pedidos uma palavra passe e uma senha pro mysql
                                    
 							<br/><br/><h4>Configurar</h4><br />
										Agora é necessário configurar quais arquivos o modperl interpretará.
 					 		...
 					 		<Files "*.pl"><h5>&lt;Files &ldquo;*.pl&rdquo;&gt;<br />
										...
										<h4>Dê permissão</h4> <br />Logado com Root Digite o comando :<br /><br />
											<h5> chmod 777 /var/www/</h5>
										<br/>
										<h4>PhpMyadmin</h4><br />
									Para quem quiser manipular banco de dados pela ferramenta é uma boa ideia<br/><br/>
										<h5>sudo apt-get install phpMyadmin</h5>
 							 		<br />logo em seguinda coloque sua senha de root<br/>
                                    
                                    
                                    <br/><h4>  Xampp no LINUX</h4><br/>
                                    	<p> outra opção mais rapida é a instalação do xampp em vez  da instalaçãoa comun
                              ...
                              title="Download Xampp" title="Download do Xampp">Xampp Linux</a></center>
                                        ...
                                        <p> Após terminar o downlad , Abra o terminal e digite o seguinte Comando chegue até a pasta                                                  onde está o arquivo baixado e o execute-o</p>
                                        
                                        	<h5> ./nome-do-arquivo</h5><br/>
                                    
                                    	<p>Conclua a Instalação Clicando NEXT nas janelas</p><br/>
                                        	<center><img src="images/Instalação XAMMP - Bem-vindo.png" title="imagem do perl">
                                    			</center>
                                                
                                                
                                               <br/> Para Iniciar os serviços ou paralos Execute os comandos<br/><br/>
                                               		<h5>sudo /opt/lammp/lampp start <br/>sudo /opt/lammp/lampp stop
                                                    <br/>sudo /opt/lammp/lampp restart</h5>
                                          				     
                                                     <br/><br/> 
                                                               
                                         <h4> Configuração </h4><br/>
                                           <p>Adicione as seguintes linhas no arquivo httpd.conf para que reconhecida a exentesão                                                             index.pl
                                                
                                                <br/>
                                           	<h5> sudo gedit /opt/lammp/etc/httpd.conf</h5>
                                            
                                            	<br/> Procure essa linha  e  coloque os seguintes Comandos<br/><br/> 
                                            		<img src="images/source.png" title="Configuração index.pl">
